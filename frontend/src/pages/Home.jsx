  ...
  return (
    <div className="home-page">
      <header className="home-nav fade-in-up">
        ...
        <div className="home-nav-actions home-nav-actions--desktop">
          <ThemeToggle />
        ...
        <div className={`home-mobile-menu ${menuOpen ? 'open' : ''}`}>
          <div className="home-mobile-theme">
            <span>Theme</span>
            <ThemeToggle />
          </div>
          <button className="btn-ghost" onClick={() => go('/login')}>Sign in</button>
      ...
      <section className="home-hero section">
        ...
        <div className="hero-actions fade-in-up stagger" style={{ '--delay': '0.2s' }}>
          <button className="btn-glow ripple-btn" onClick={() => go('/register')}>Start free</button>
      ...
      <section className="home-cta section">
        <div className="glass-card cta-card fade-in-up">
          ...
          <button className="btn-glow ripple-btn" onClick={() => go('/register')}>Create free account</button>
        </div>
      </section>
